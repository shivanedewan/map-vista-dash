      ...
      <header className="bg-dashboard-header border-b border-border px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-foreground">MapVista Dashboard</h1>
        ...
        <main className="flex-1 overflow-hidden">
          {selectedIndex ? (
            <div className="h-full flex flex-col">
              ...
              <div className="bg-dashboard-header border-b border-border p-6">
                <div className="flex items-center justify-between">
                  ...
                  <Badge variant="secondary">{selectedIndex.category}</Badge>
                </div>
              </div>
            ...
            <div className="h-full flex items-center justify-center p-6">
              <Card className="max-w-2xl w-full text-center space-y-6 p-8">
                ...
                <div className="grid grid-cols-3 gap-4 text-center">
                  ...
                  <div className="space-y-2">
                    <TrendingUp className="h-8 w-8 mx-auto text-data-orange" />
